...
class MiniSection(Section):
    ...
    def __setitem__(self, key, value, unrepr=False):
        '''
        Tap into the base class Section (defined above) to track changes to the Config Settings
        '''
        Section.__setitem__(self, key, value, unrepr)

        # Using our class MiniSection, redo the step in Section.__setitem__()
        # where Section is used.
        if type(value) == dict and not unrepr:
            dict.__setitem__(
                self,
                key,
                MiniSection(
                    ...
                    indict=value,
                    name=key))
        # Track the changes we need to track
...
class MiniConfigObj(MiniSection):
    """
    An object to read, create, and write config files. This class is an adaptation of
    class ConfigObj to work with our custom class MiniSection (which is adapted from Section).
    """
    ...
    def __init__(self, infile=None, options=None, configspec=None, encoding=None,
        ...
        # init the superclass
        MiniSection.__init__(self, self, 0, self)
    ...
    def _handle_configspec(self, configspec):
        ...
        if not isinstance(configspec, MiniConfigObj):
            try:
                configspec = MiniConfigObj(configspec,
                                       raise_errors=True,
                                       file_error=True,
                                       _inspec=True)
    ...
    def _set_configspec(self, section, copy):
        ...
        for entry in configspec.sections:
            ...
            if isinstance(section[entry], MiniSection):
    ...
    def write(self, outfile=None, section=None):
        ...
        for entry in (section.scalars + section.sections):
            ...
            if isinstance(this_entry, MiniSection):
                # a section
            ...
            try:
                ...
                if self.stringify or missing:
                    ...
                    if (check != val) or missing:
                        section[entry] = check
                        section.main._changed = False    # Undo a side effect of __setitem__
